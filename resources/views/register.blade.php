        ...
        <form action="POST" class="flex flex-col gap-6">
            <div class="flex flex-col gap-2">
                <label for="username">
                    ...
                    <input id="username" name="username" type="text" class="mt-1 px-6 py-3 font-normal md:text-base bg-white border shadow-sm border-slate-300 placeholder-slate-400 focus:outline-none focus:border-sky-500 focus:ring-sky-500 block w-full rounded-md text-sm focus:ring-1" placeholder="{{ __('forms.enter unique username') }}"/>
                </label>
            </div>
            <div class="flex flex-col gap-2">
                <label for="email">
                    <span class="block font-bold text-sm md:text-base">{{ __('forms.email') }}</span>
                    <input id="email" name="email" type="email" class="mt-1 px-6 py-3 font-normal md:text-base bg-white border shadow-sm border-slate-300 placeholder-slate-400 focus:outline-none focus:border-sky-500 focus:ring-sky-500 block w-full rounded-md text-sm focus:ring-1" placeholder="{{ __('forms.enter your email') }}"/>
                </label>
            </div>
            <div class="flex flex-col gap-2">
                <label for="password">
            ...
            <x-form-button text="{{ __('forms.sign up') }}"></x-form-button>
